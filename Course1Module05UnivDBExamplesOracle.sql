...
3. 
-- Extra table (Course) in the statement
-- Same result as example 2 but slower execution speed because of extra table
...
-- Use SELECT statement to see the new row.
SELECT * FROM Student WHERE StdNo = '999-99-9999';
...
-- Use SELECT statement to see changes to the row.
SELECT * FROM Student WHERE StdNo = '999-99-9999';
...
-- Use SELECT statement to see that the row has been deleted.
SELECT * FROM Student WHERE StdNo = '999-99-9999';
