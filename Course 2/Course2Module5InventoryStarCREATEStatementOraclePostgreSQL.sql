-- CREATE TABLE statements for the Inventory DW tables
-- Use for both Oracle Cloud and PostgreSQL
...
CREATE TABLE inventory_fact(
  InventoryKey    INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
